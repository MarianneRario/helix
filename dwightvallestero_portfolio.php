      ...
      <div class="container">
         <header id="main-header">
            <div class="row no-gutters">
               <div class="col-lg-4 col-md-5">  
                  <img src="images/dwight_pic.jpg" alt="">
               </div>
               <div class="col-lg-8 col-md-7">
                  <div class="d-flex flex-column">
                     <div class="p-5 bg-dark text-white">
                        <div class="d-flex flex-row justify-content-between align-items-center">
                           <h1 class="display-4">Dwight Vallestero Jr.</h1>
         ...
         <div id="home" class="collapse show">
            <div class="card card-body bg-primary text-white py-5">
               <h2>My Profile</h2>
               <p class="lead">Knowledge and through information technology technician with superior attention to detail.
               Driven and self-motivated, and therefore effective at completing task under minimal supervision. Confident 
               performer and enthusiastic communicator.
               </p>
            </div>
            <div class="card card-body py-5">
               <h3>My Skills</h3>
               <b>Software</b>
               <p>Installation and debugging various software on different operating systems specifically iOS, MacOS, and Windows.
               </p>
               <b>Troubleshooting Skills</b>
               <p>Flexibly able to troubleshoot both hardware and software issues on iOS and Windows OS, and basic troubleshooting 
               knowledge for MacOS.
               </p>
               <b>Customer and User Support</b>
               <p>Willingness to communicate and work with the customer or users concern or feedback.</p>
               <hr>
               <h4>Java</h4>
         ...
         <div id="resume" class="collapse">
            <div class="card card-body bg-success text-white py-5">
               <h2>My Resume</h2>
               <p class="lead">If someone is looking for a person with a creative spirit, reliable and professional, organized, who
               have time management skills, team player, fast learner, motivated and willing to work under pressure, then I'm the
               one that you need.
               </p>
            </div>
            <div class="card card-body py-5">
               <h3>Where Have I Worked?</h3>
               <p>Able to work hand in hand with the developer team and contributed to the group in term of documentation. Additionally,
               analyzed the source code and the output of the program.
               </p>
               <div class="card-deck">
                  <div class="card">
                     <div class="card-body">
        ...
        <form>
          <div class="form-group">
            <div class="input-group input-group-lg">
              ...
              <input class="form-control bg-dark text-white" value="Dwight Vallestero" readonly/>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="input-group input-group-lg">
              ...
              <input class="form-control bg-dark text-white" value="dwight.vallestero@my.jru.edu" readonly/>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="input-group input-group-lg">
              ...
              <input class="form-control bg-dark text-white" value="(0990) 323 1231" readonly/>
            </div>
          </div>
        </form>
      </div>
