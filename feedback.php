               ...
               <form action="" class="form-container" method="post">
                ...
                <!--HIDDEN INPUT-->
                  ...
                  <div class="form-group">
                     <label>In order to ensure that we meet our customer's needs, 
                     we are kindly asking you to take a few minutes to give us some feedback. </label>
                     <textarea class="form-control" name="editor1"><?php echo $row['feedback'] ?></textarea>
                  </div>
                  <button type="submit" name="submit-feedback" class="btn btn-success btn-block">
