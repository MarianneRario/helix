         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item px-2">
                     <a href="register_project.php" class="nav-link active">Register Project</a>
                  </li>
                  <li class="nav-item px-2">
      ...
      <header id="main-header" class="py-2 bg-info text-white">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h1>
                  <i class="fas fa-edit"></i> Project Panel
                  </h1>
               </div>
            </div>
         </div>
            ...
            <section class = "col-12 col-sm-6 col-sm-4">
               <form action="" class="form-container" method="post">
                ...
                <!--HIDDEN INPUT-->
                  ...
                  <button type="submit" name="save-project" class="btn btn-success btn-block">
